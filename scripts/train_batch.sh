#!/usr/bin/env bash
# ==============================================================================
# eu-kiki LoRA Batch Training — Solid Domains (>=1000 examples)
#
...
EUROLLM="$KIKI_TUNNER/models/EuroLLM-22B-Instruct-2512"

# -----------------------------------------------------------------------------
# Execution plan
# -----------------------------------------------------------------------------
echo "============================================================"
echo " eu-kiki LoRA Batch Training Plan"
...
# --- GROUP 1: Devstral-24B (coding domains) ---
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " GROUP 1: Devstral-Small-2-24B (coding)"
...
train_one "devstral" "rust"          "$DEVSTRAL"  4  2048  2850     500
train_one "devstral" "typescript"    "$DEVSTRAL"  4  2048  2850     500
train_one "devstral" "sql"           "$DEVSTRAL"  4  2048  2850     500
train_one "devstral" "docker-devops" "$DEVSTRAL"  4  2048  1656     500
train_one "devstral" "llm-ops"       "$DEVSTRAL"  4  2048  1379     500

# --- GROUP 2: Apertus-70B (reasoning domains) ---
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " GROUP 2: Apertus-70B (reasoning)"
echo " Params: grad_accum=8, max_seq=1024, iters=500"
echo " Est. ~45 min/domain × 4 domains = ~180 min"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

train_one "apertus" "math-gsm8k"       "$APERTUS"  8  1024  2850  500
train_one "apertus" "embedded"         "$APERTUS"  8  1024  2850  500
train_one "apertus" "emc-dsp-power"    "$APERTUS"  8  1024  2850  500
train_one "apertus" "security-fenrir"  "$APERTUS"  8  1024  2850  500

# --- GROUP 3: EuroLLM-22B (multilingual) ---
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " GROUP 3: EuroLLM-22B (multilingual)"
echo " Params: grad_accum=4, max_seq=2048, iters=500"
echo " Est. ~25 min/domain × 2 domains = ~50 min"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

train_one "eurollm" "multilingual-eu"  "$EUROLLM"  4  2048  2850  500
train_one "eurollm" "traduction-tech"  "$EUROLLM"  4  2048  2850  500
